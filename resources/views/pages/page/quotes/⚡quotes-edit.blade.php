    ...
    <div>
        <div class="mb-1 space-y-1">
            <flux:heading size="xl" level="1">
                <a href="{{ route('quotes.index') }}"><flux:button size="xs" variant="ghost" icon="arrow-uturn-left"></flux:button></a>
                {{ $this->titlePage }}
            </flux:heading>
            ...
            <flux:breadcrumbs>
                ...
                <flux:breadcrumbs.item href="{{ route('quotes.index') }}">Frases</flux:breadcrumbs.item>
