...
new class extends Component
{
    ...
    public string $title = 'Agregar genero de libro';
    public string $subtitle = 'Agregue un genero de libro a la lista';
    ...
    protected function rules(){
        return [
            ...
            'slug' => ['required', 'string', 'max:255', \Illuminate\Validation\Rule::unique('book_genres', 'slug')->ignore($this->subject?->id ?? 0)],
            'name_general' => ['required', 'string', 'max:255'],
            'slug_general' => ['required', 'string', 'max:255', \Illuminate\Validation\Rule::unique('book_genres', 'slug')->ignore($this->subject?->id ?? 0)],
            'description' => ['nullable', 'string'],
            'cover_image_url' => ['nullable', 'url', 'max:65535'],
            'uuid' => ['required', 'string', 'max:255', \Illuminate\Validation\Rule::unique('book_genres', 'uuid')->ignore($this->subject?->id ?? 0)],
