...
new class extends Component
{
    ...
    public string $title_movie = 'Editar pelicula';
    public string $subtitle = 'Edite un pelicula de la lista';
    ...
    // public $selectedMovieTags = [];     // array de tags agregados
    ...
    <div class="space-y-2">
        ...
        <div class="flex items-center gap-1">
            <flux:modal.trigger name="add-subject">
                <flux:button size="xs" variant="ghost" icon="plus"></flux:button>
                <flux:label>Actor {{ count($selectedMovieSubjects) }}</flux:label>
            </flux:modal.trigger>
        </div>
        <flux:checkbox.group wire:model.live="selectedMovieSubjects">
