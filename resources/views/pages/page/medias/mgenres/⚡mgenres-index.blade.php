...
new class extends Component
{
    ...
    public function deleteItem($codigo){
        $item = Mgenre::where('user_id', Auth::id())->where('uuid', $codigo)->first();
        $item->delete();
    }
...
<div>
    ...
    {{-- listado de sujetos --}}
    <div class="space-y-2">
        @foreach ($this->queryMgenres() as $item)
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center justify-center">
                        <a href="{{ route('mgenres.edit', ['mgenreUuid' => $item->uuid]) }}"><flux:button size="xs" variant="ghost" icon="pencil-square"></flux:button></a>
    ...
    <div class="flex justify-between items-center gap-1">
        ...
        <div class="flex gap-3">
            <flux:button icon="cloud-arrow-up" class="text-xs text-center" wire:click="import('mgenres')">Imp.</flux:button>
