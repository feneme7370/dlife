...
new class extends Component
{
    ...
    public string $subtitle = 'Agregue un etiqueta a la lista';
    ...
    protected function rules(){
        return [
            ...
            'slug' => ['required', 'string', 'max:255', \Illuminate\Validation\Rule::unique('book_genres', 'slug')->ignore($this->mtags?->id ?? 0)],
            'uuid' => ['required', 'string', 'max:255', \Illuminate\Validation\Rule::unique('book_genres', 'uuid')->ignore($this->mtags?->id ?? 0)],
